...
namespace _01_Framework.Application
{
    public static class Tools
    {
        ...
        public static string GetFarsiYear(this string date)
        {
            return date.Substring(0, 4);
        }

        public static string GetFarsiDayNumber(this string date)
        {
            return date.Substring(8, 2);
        }

        public static string GetFarsiMonth(this string date)
        {
            string farsiMonthName = "فروردین";
            switch (int.Parse(date.Substring(5, 2)))
            {
                case 2:
        ...
        public static string ToEnglish(this DateTime date)
        {
            if (date == new DateTime()) return "";
            string expireDate = $"{date.Year}/{date.Month}/{date.Day}";
            return expireDate;
        }
